...
namespace MateoJijon1_Ejercicio.Controllers
{
    public class BurgersController : Controller
    {
        private readonly MateoJijon1_EjercicioContext _context;

        public BurgersController(MateoJijon1_EjercicioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'MateoJijon1_EjercicioContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MateoJijon1_EjercicioContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
